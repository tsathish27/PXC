...
import { FilmIcon, CalendarIcon, PlaneIcon, MoveHorizontalIcon, ListIcon } from '../components/Icons'; // Import your icons

import TicketSections from '../components/TicketSections'; // Adjust the path based on your project structure
